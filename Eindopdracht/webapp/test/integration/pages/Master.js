		...
		onTheMasterPage : {
			...
			actions : {
				...
				iSortTheListOnUnitNumber : function () {
					return this.iChooseASorter("sortButton", "Sort By <TaxCode>");
				},

				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<TaxCode>", "<100 <SupplierId>");
				},

				iGroupTheList : function () {
					return this.iChooseASorter("groupButton", "<TaxCode> Group");
				},
			...
			assertions : {
				...
				theListShouldBeFilteredOnUnitNumber : function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("TaxCode", 100);
				},


				theListShouldBeSortedAscendingOnUnitNumber : function () {
					return this.theListShouldBeSortedAscendingOnField("TaxCode");
				},
